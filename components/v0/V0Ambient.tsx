// v0-only ambient orbs (pink/violet/magenta) — frozen so global changes can't affect /v0
const ORBS = [
...
export default function V0Ambient() {
  return (
    <div className="ambient-v0" aria-hidden>
      {ORBS.map((o, i) => {
